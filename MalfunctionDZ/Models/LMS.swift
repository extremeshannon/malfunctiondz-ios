...
enum ReadingAssignmentHelper {
    static func letter(fromLessonTitle title: String) -> String? {
        ...
        for letter in ["A", "B", "C", "D", "E", "F", "G", "H"] {
            if t == "Category \(letter) Reading" || t == "Category \(letter) Quiz" {
                return letter
            }
        }
        return nil
